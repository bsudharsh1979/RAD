  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-3 md:grid-cols-2">
        {rows.map((n) => (
          <Link key={n.id} href={`/notebooks/${encodeURIComponent(n.filename)}?walkthrough=1`} className="panel block p-4 hover:border-[#76b900]">
            ...
            <p className="mt-2 text-xs text-[#76b900]">Open with lecture →</p>
          </Link>
        ))}
      </div>
    </div>
